#// Don't forget to hit SUBSCRIBE, LIKE, COMMENT, SHARE! and LEARN! its good to learn! :)
...
def banner():
    ...
    print('Copyright: (png internethub)')
    print('coded by ')
    print('MIT Licence: Licence in repository')
    print('Description: PNG internet hub USE THIS FOR EDUCATIONAL USE WE NOT
    	print('responsible for any of your wrong full action. :)')
    time.sleep(1)
...
def main():
    ...
    print("\n\n[**] Lionub is complete, all subdomains have been found.")
